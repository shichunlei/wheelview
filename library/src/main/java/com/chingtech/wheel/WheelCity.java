...
public class WheelCity {
    ...
    public void initCityPicker(String[] provinceArray, final String[][] cityArray,
        ...
        provinceView = view.findViewById(R.id.wheelcity_country);
        ...
        cityView = view.findViewById(R.id.wheelcity_city);
        cityView.setCyclic(false);// 不循环
        cityView.setVisibleItems(0);

        districtView = view.findViewById(R.id.wheelcity_ccity);
        ...
        OnWheelChangedListener provinceListener = new OnWheelChangedListener() {
            ...
            public void onChanged(WheelCityView wheel, int oldValue, int newValue) {
                ...
                setTxt(provinceView.getCurrentItem(), cityView.getCurrentItem(),
        ...
        OnWheelChangedListener cityListener = new OnWheelChangedListener() {
            ...
            @Override
            public void onChanged(WheelCityView wheel, int oldValue, int newValue) {
                updatecCities(districtView, districtArray, provinceView.getCurrentItem(), newValue);
                setTxt(provinceView.getCurrentItem(), cityView.getCurrentItem(),
                       districtView.getCurrentItem());
            }
        };
        ...
        provinceView.addChangingListener(provinceListener);
        cityView.addChangingListener(cityListener);
        districtView.addChangingListener(districtListener);
     ...
     */
    private void updateCities(WheelCityView wheelView, String cityArray[][], int index) {
     ...
     */
    private void updatecCities(WheelCityView wheelView, String districtArray[][][], int index,
            int index2) {
        ArrayWheelAdapter<String> adapter = new ArrayWheelAdapter<>(context,
                                                                          districtArray[index][index2]);
        adapter.setTextSize(18);
        wheelView.setViewAdapter(adapter);
        wheelView.setCurrentItem(0);
    }
