...
package com.chingtech.wheelcity;
...
import com.chingtech.wheelcity.adapters.WheelViewAdapter;
 ...
 */
public class WheelCityView extends View {
	 ...
	 * Constructor
	 */
	public WheelCityView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelCityView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
