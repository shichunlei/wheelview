...
public class WheelText {
	...
	public void initTextPicker(final ArrayList<String> items,
			final String[] array) {
		textWheel = (WheelView) view.findViewById(R.id.text);

		if (null == array) {
			textWheel.setAdapter(new ArrayListWheelAdapter<String>(items));
		} else if (null == items) {
			textWheel.setAdapter(new ArrayWheelAdapter<String>(array));
		}
		index = 0;
